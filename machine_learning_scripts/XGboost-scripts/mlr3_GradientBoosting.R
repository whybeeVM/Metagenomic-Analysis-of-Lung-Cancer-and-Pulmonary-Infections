...
name = paste0(group1, "_vs_", group2, "_XGB_", args[5])
...
classif.task
classif.lrn = lrn("classif.xgboost", predict_type = "prob")
classif.lrn

rdesc = rsmp("repeated_cv", folds = 10, repeats = 3)
rdesc
...
p4 <- ggbarplot(feature_import, 
               ...
               palette = "jco",
               sort.val = "asc",
               ylab = "Gradient Boosting importance",
               xlab = "", legend="none") +
