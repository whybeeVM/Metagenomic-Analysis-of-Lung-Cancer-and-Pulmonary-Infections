...
name = paste0(group1, "_vs_", group2, "_XGB")
...
#    scale_x_reverse()+
  ...
  write.table(feature_import, paste0(name, "_feature_",i,'_importance.txt'), sep = '\t', col.names = NA, quote = FALSE)
  ggsave(paste0(name, "_feature_",i, "_feature_importance.png"), p4, width = 6, height = 4)
  ggsave(paste0(name, "_feature_",i, "_feature_importance.pdf"), p4, width = 6, height = 4)
  }
